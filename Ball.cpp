...
Ball::Ball(RenderWindow &window, Board &platform, Data &information, Design &level) :
				window(&window),
...
Ball::Ball(RenderWindow &window, Board &platform, Data &information, Design &level, Color color) :
				window(&window),
				color(color),
				radius(ball_standart_radius),
				coord((gameWidth - ball_standart_radius) / 2, 500),
